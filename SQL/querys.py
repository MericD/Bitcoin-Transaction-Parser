...
__add_tx_qy = """INSERT INTO tx 
    (transaction_id, version, tx_size ,vin_size, vout_size, tx_value, tx_time, op_return, block_number) 
    VALUES 
...
def get_add_tx_query(tx_id, tx_v, tx_s ,tx_vin_size, tx_vout_size, tx_val, tx_ti, tx_op_return, tx_block_id):
