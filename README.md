...
* A line chart plots the occurrences of OP_RETURN field containing transactions. The plots will be created as PNG and PDF files and stored in the plots folder.
